const portfolioData = [
  ...
  image: 'https://readdy.ai/api/search-image?query=Cloud%20infrastructure%20visualization%20with%20servers%2C%20network%20connections%2C%20and%20data%20flow%20diagrams.%20Modern%20tech%20illustration%20showing%20cloud%20computing%20architecture%2C%20server%20clusters%2C%20and%20network%20topology.%20Professional%20red%20and%20white%20color%20scheme%20with%20clean%20geometric%20design.&width=600&height=400&seq=portfolio-red-4&orientation=landscape'
  ...
  return (
    <section className="py-16 px-6 md:px-20 bg-gray-50">
      <div className="text-center mb-10">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Our Portfolio</h2>
        <p className="mt-3 text-gray-600 max-w-xl mx-auto">
          Explore our recent projects and discover how we’ve helped businesses transform their
